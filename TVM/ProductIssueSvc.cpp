...
bool CProductIssueSvc::IsCoinMaxCount(){
	...
	//CTCoinCountInfo::COIN_HOPPER_BOX_INFO stock				 = theCOIN_COUNT.GetCoinHopperboxCInfo();
	//// 2.回收箱最大可接收数量
...
*/
//////////////////////////////////////////////////////////////////////////
void CProductIssueSvc::GetAcceptBanknotesFace(tBncSetInhibitList* table){
	vector<WORD> vecFace;
	BNC_FACE_ACEPTED_TABLE bhAcceptTable;
