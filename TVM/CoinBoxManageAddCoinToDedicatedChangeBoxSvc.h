...
public:
	...
	typedef struct change_box_info			   //  硬币找零箱信息结构
	{
		...
		// 取软计数信息
		void GetCoinChangeCountInfo(CTCoinCountInfo::COIN_HOPPER_BOX_INFO/*COIN_CHANGE_BOX_INFO*/& info)
		{
...
private:
	...
	CTCoinCountInfo::COIN_HOPPER_BOX_INFO mEx_hopper_A;	
	CTCoinCountInfo::COIN_HOPPER_BOX_INFO mEx_hopper_B;
