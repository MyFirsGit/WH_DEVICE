...
bool CCoinBoxManageCollectCoinSvc::DoCollectStockBox()
{
	...
	//CTCoinCountInfo::COIN_HOPPER_BOX_INFO coinboxinfo;	
...
bool CCoinBoxManageCollectCoinSvc::ExecuteCollection()
{
	...
	CTCoinCountInfo::COIN_HOPPER_BOX_INFO hopperA = theCOIN_COUNT.GetCoinHopperboxAInfo();// 一元
	CTCoinCountInfo::COIN_HOPPER_BOX_INFO hopperB = theCOIN_COUNT.GetCoinHopperboxBInfo();// 5角
