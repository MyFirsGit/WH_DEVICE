...
@param     (i)COIN_HOPPER_BOX_INFO& boxInfo  硬币箱计数信息
...
*/
//////////////////////////////////////////////////////////////////////////
BOOL CTCoinCountInfo::SetCoinHopperboxAInfo(COIN_HOPPER_BOX_INFO& boxInfo)
{
	try{
		boxInfo.CheckMinusValue();
		boxInfo.Serialize((LPBYTE)m_fileData);
...
@retval     COIN_HOPPER_BOX_INFO& 硬币箱的计数信息

@exception  无
*/
//////////////////////////////////////////////////////////////////////////
CTCoinCountInfo::COIN_HOPPER_BOX_INFO& CTCoinCountInfo::GetCoinHopperboxAInfo()
{
...
*/
//////////////////////////////////////////////////////////////////////////
BOOL CTCoinCountInfo::SetCoinHopperboxBInfo(COIN_HOPPER_BOX_INFO& boxInfo)
{
	try{
		boxInfo.CheckMinusValue();
		boxInfo.Serialize((LPBYTE)m_fileData+16);
...
*/
//////////////////////////////////////////////////////////////////////////
CTCoinCountInfo::COIN_HOPPER_BOX_INFO& CTCoinCountInfo::GetCoinHopperboxBInfo()
{
