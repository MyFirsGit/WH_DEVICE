...
public:
	...
	// 硬币HOPPER箱计数信息
	typedef struct _COIN_HOPPER_BOX_INFO {
	...
	BOOL SetCoinHopperboxAInfo(COIN_HOPPER_BOX_INFO& boxInfo);					// 设置硬币HOPPER箱A的计数信息(面对模块：右边)(五角)
	COIN_HOPPER_BOX_INFO& GetCoinHopperboxAInfo();								// 读取硬币HOPPER箱A的计数信息(面对模块：右边)(五角)

	BOOL SetCoinHopperboxBInfo(COIN_HOPPER_BOX_INFO& boxInfo);					// 设置硬币HOPPER箱B的计数信息(面对模块：左边)(一元)
	COIN_HOPPER_BOX_INFO& GetCoinHopperboxBInfo();								// 读取硬币HOPPER箱B的计数信息(面对模块：左边)(一元)
	...
	// 硬币计数变更事件
	delegate<void(COIN_HOPPER_BOX_INFO&)>				CoinBoxCounterChanged;
...
private:
	...
	COIN_HOPPER_BOX_INFO  m_CoinHopperBoxAInfo;			// 硬币HOPPER箱A的计数信息
	COIN_HOPPER_BOX_INFO  m_CoinHopperBoxBInfo;			// 硬币HOPPER箱B的计数信息
