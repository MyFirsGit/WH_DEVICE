...
extern "C" {
	...
	*  0 - 执行成功; 其他 - 执行失败;
	*/
	AFC_API_DLL_IMP int DIO_Open( int nNum, tSerialConfigInfo* pSerialConfigInfo );
	/**
	 * 初始化模块，检查模块是否可用
	 *  tReturn - 返回的模块状态信息
	 * 返回值:
	 *  0 - 执行成功; 其他 - 执行失败;
	 */
	AFC_API_DLL_IMP int DIO_Init( STDioDevReturn& tReturn );
	/**
	 * DIO模块关闭
	 * 返回值:
	 *  0 - 执行成功; 其他 - 执行失败;
	 */
	AFC_API_DLL_IMP int DIO_Close();
	 ...
	 *  0 - 执行成功; 其他 - 执行失败;
	 */
	AFC_API_DLL_IMP int DIO_SetLampSignal( STDioLampConfig* pLampConfig, unsigned char ucLampCnt, STDioDevReturn& tReturn );
	/**
	 * 设置提示灯信号
	 ...
	 *  0 - 执行成功; 其他 - 执行失败;
	 */
	AFC_API_DLL_IMP int DIO_SetSwitchSignal( STDioSignalConfig* pSignalConfig, unsigned char ucSignalCnt, STDioDevReturn& tReturn );
	/**
	 * 设置提示灯信号
	 ...
	 *  0 - 执行成功; 其他 - 执行失败;
	 */
	AFC_API_DLL_IMP int DIO_GetSwitchSignal( STDioSignalConfig* pSignalConfig, unsigned char& ucSignalCnt, STDioDevReturn& tReturn );
	/**
	 * 获取模块固件版本
	 *  tVersion - 模块固件版本信息
	 *  tReturn - 返回的模块状态信息
	 ...
	 *  0 - 执行成功; 其他 - 执行失败;
	 */
	AFC_API_DLL_IMP int DIO_GetVersion( STDioVerInfo& tVersion, STDioDevReturn& tReturn );
	// <<<<
}
